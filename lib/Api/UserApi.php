...
class UserApi
{
     ...
     * @throws \Stan\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Stan\Model\User[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getUserWithHttpInfo()
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Stan\Model\User[]' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Stan\Model\User[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Stan\Model\User[]';
